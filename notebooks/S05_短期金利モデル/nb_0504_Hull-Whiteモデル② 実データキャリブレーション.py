...
# | 用語 | 英語 | 一行定義 |
# |---|---|---|
# | [キャリブレーション](../../glossary/05_rate_models.md#calibration) | calibration | モデルパラメータを市場価格に最も近づけるよう推定する作業 |
# | [Levenberg-Marquardt法](../../glossary/05_rate_models.md#levenberg-marquardt) | Levenberg-Marquardt | ガウス・ニュートンと最急降下を補間する非線形最小二乗法 |
# | [識別性](../../glossary/05_rate_models.md#identifiability) | identifiability | データからパラメータを一意に決められる度合い |
# | [局所解](../../glossary/05_rate_models.md#local-minimum) | local minimum | 目的関数の谷のうち大域最小でないもの。初期値依存で落ちうる |
# | [ATMボラ](../../glossary/05_rate_models.md#at-the-money-volatility) | at-the-money volatility | 行使レートをフォワードに一致させたときのインプライドボラ |
