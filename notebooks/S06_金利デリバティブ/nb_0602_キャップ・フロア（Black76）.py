...
# %% [markdown]
# **数値例**：$F=3.0\%,\ K=3.2\%,\ T=2,\ \sigma=25\%,\ P(0,T_i)=0.95$ のとき $d_1=\dfrac{\ln(0.030/0.032)+\tfrac12\cdot0.25^2\cdot2}{0.25\sqrt2}=-0.0058,\ d_2=-0.3593$ で、コール価格は $0.95\,\bigl(0.030\,\Phi(d_1)-0.032\,\Phi(d_2)\bigr)=0.003250$（＝約 $32.5$ bp）となります。
#
# **数値例**：ATM 近傍の変換 $\sigma_N\approx\sigma_{\text{LN}}\cdot L_0$ に $\sigma_{\text{LN}}=25\%,\ L_0=3.0\%$ を入れると $\sigma_N\approx 0.25\times0.030=0.0075=75$ bp。対数正規ボラ25%は正規ボラ約75bpに対応します。
# %% [markdown]
# ## スクラッチ実装
#
