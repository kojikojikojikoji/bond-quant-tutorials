...
# | 用語 | 英語 | 一行定義 |
# |---|---|---|
# | [スワップション](../../glossary/06_derivatives.md#swaption) | swaption | 将来スワップに入る権利。フォワードスワップレートのオプション |
# | [アニュイティ測度](../../glossary/06_derivatives.md#annuity-measure) | annuity measure | アニュイティをニュメレールに選んだ測度。スワップレートがマルチンゲール |
# | [Jamshidian 分解](../../glossary/06_derivatives.md#jamshidian-decomposition) | Jamshidian decomposition | 1 ファクター下でスワップションを割引債オプションの和に分解する手法 |
# | [ストラドル](../../glossary/06_derivatives.md#straddle) | straddle | 同一行使・満期の payer と receiver を同時保有する、ボラ取引の代表形 |
